...
Перед коммитом проверьте, что в diff нет `.env`, токенов, логов, баз данных,
backup-файлов, IDE-state и других локальных артефактов.
...
5. Убедитесь, что AGPL-3.0 obligations сохраняются для измененных файлов.
...
4. Do not commit secrets, logs, databases, backups, IDE state, or generated bytecode.
